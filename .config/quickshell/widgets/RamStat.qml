...
RowLayout {
    ...
    property int value: System.ramPercent
    property string label: System.ramUsed + "GB"
    ...
    Item {
        ...
        Item {
            ...
            Image { id: icon; anchors.centerIn: parent; source: "../assets/icons/ram.svg"; width: 14; height: 14; visible: false }
